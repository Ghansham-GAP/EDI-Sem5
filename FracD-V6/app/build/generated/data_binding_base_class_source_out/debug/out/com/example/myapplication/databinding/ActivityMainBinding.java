...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull LinearLayout rootView, @NonNull TextView headerTitle,
      ...
      @NonNull MaterialButton selectButton, @NonNull ImageButton shareButton) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      LinearLayout resultTextLayout = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ActivityMainBinding((LinearLayout) rootView, headerTitle, historyButton, imageView,
          predictButton, progressBar, resultText, resultTextLayout, selectButton, shareButton);
    }
